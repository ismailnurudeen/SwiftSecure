...
public class CrimeReportRecyclerAdapter extends RecyclerView
        .Adapter<CrimeReportRecyclerAdapter
        .DataObjectHolder> {
    private static String LOG_TAG = "MyRecyclerViewAdapter";
    private ArrayList<CrimeReports> mDataset;
...
// Toast.makeText(this,"This is card View",Toast.LENGTH_LONG).show();
    ...
    public CrimeReportRecyclerAdapter(ArrayList<CrimeReports> myDataset) {
        mDataset = myDataset;
    }
    @Override
    ...
    public void addItem(CrimeReports dataObj, int index) {
